...
// === METODOS === //
	...
	public void setData(int b, int c) throws Exception {
		...
		if(dia >= 0 && dia <= 31) {
			if(mes >= 1 && mes <= 12) {
				if(!(dia >29 && mes==2)) {
					if(ano > 1582) {
						switch(mes) {
							case 1:{nDia = 31; Data.setMs = "Janeiro"; x = true;break;}
							...
							case 3:{nDia = 31; this.mesTxt = "Março"; x = true;break;}
							
							case 4:{nDia = 30; if(dia <= nDia) {this.mesTxt = "Abril"; x = true;} else x = false;break;}
							
							case 5:{nDia = 31; this.mesTxt = "Maio"; x = true;break;}
							
							case 6:{nDia = 30; if(dia <= nDia) {this.mesTxt = "Junho"; x = true;} else x = false;break;}
							
							case 7:{nDia = 31; this.mesTxt = "Julho"; x = true;break;}
							
							case 8:{nDia = 31; this.mesTxt = "Agosto"; x = true;break;}
							
							case 9:{nDia = 30; if(dia <= nDia) {this.mesTxt = "Setembro"; x = true;} else x = false;break;}
							
							case 10:{nDia = 31; this.mesTxt = "Outubro"; x = true;break;}
							
							case 11:{nDia = 30; if(dia <= nDia) {this.mesTxt = "Novembro"; x = true;} else x = false;break;}
							
							case 12:{nDia = 31; this.mesTxt = "Dezembro"; x = true;break;}
	...
	public static void verificaECriaData(int dia, int mes, int ano) {
		try{
			if(isDataValida(dia, mes,ano)) {};
		}
		catch (Exception e) {}
	}//FIM VERIFICA E CRIA DATA
}//FIM CLASS DATA
