...
public class Uso {
	public static void main(String args[]) {
		try {
			...
			Retangulo a = new Retangulo(4.0, 4.0, 1.0, 1.0);
			Retangulo b = new Retangulo(1.0, 1.0, 2.0, 2.0);
			
			System.out.println("Sao iguais? " + Ponto.equals(a.getPontoDI(), b.getPontoDI()));
			b.setRetangulo(2, 2, -3, -3);
